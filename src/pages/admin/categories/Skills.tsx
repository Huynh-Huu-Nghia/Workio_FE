...
const Skills: React.FC = () => {
  ...
  return (
    <AdminLayout title="Kỹ năng" activeMenu="categories">
      <div className="rounded-2xl border border-gray-100 bg-white shadow-sm">
        <div className="border-b border-gray-100 p-5">
          <h1 className="text-xl font-semibold text-gray-800">Danh mục kỹ năng</h1>
        ...
        <div className="grid gap-4 p-5 lg:grid-cols-3">
          <div className="lg:col-span-1 rounded-xl border border-gray-100 bg-gray-50/60 p-4">
            <h2 className="text-sm font-semibold text-gray-800">Thêm kỹ năng</h2>
